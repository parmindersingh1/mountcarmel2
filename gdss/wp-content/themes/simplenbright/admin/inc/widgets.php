...
function site5framework_widgets_init() {
	...
	register_sidebar( array(
    'name' => __( 'Footer 1', 'site5framework' ),
    'id' => 'footer-1', 
	'description' => __( "Widetized footer", 'site5framework' ),
	...
	register_sidebar( array(
    'name' => __( 'Footer 2', 'site5framework' ),
    'id' => 'footer-2',
    'description' => __( "Widetized footer", 'site5framework' ),
    'before_widget' => '<div class="boxFooter">',
    'after_widget' => '</div>',
	...
	register_sidebar( array(
    'name' => __( 'Footer 3', 'site5framework' ),
    'id' => 'footer-3', 
	'description' => __( "Widetized footer", 'site5framework' ),
    'before_widget' => '<div class="boxFooter">',
    'after_widget' => '</div>',
	...
	register_sidebar( array(
    'name' => __( 'Footer 4', 'site5framework' ),
    'id' => 'footer-4', 
	'description' => __( "Widetized footer", 'site5framework' ),
    'before_widget' => '<div class="boxFooter contact">',
    'after_widget' => '</div>',
    'before_title' => '<h2>','after_title' => '</h2>'
    ) );
}
        ...
        <h2 class="widget-title"><?php echo $instance['widget_title']; ?></h2>
	        ...
	        <div class="contactmap">
	                ...
	                <div class="address">
						...
						<br>
						<?php _e('T:', 'site5framework') ?> <?php echo $instance['cphone']; ?>
						<br>
					<p>

...
<div id="slider_container">
	<div id="slider">
			...
			<?php }?> 
			<img class="slideimg" src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo get_image_path(get_post_meta($post->ID, 'snbf_slideimage_src', true)); ?>&amp;h=345&amp;w=960&amp;zc=1" alt="<?php echo get_post_meta($post->ID, 'snbf_fitemcaption', true); ?>" title="<?php echo get_post_meta($post->ID, 'snbf_fitemcaption', true); ?>" />
			<?php if($fitemlink !=''){?>			
			</a>
			<?php }?>
			<?php echo $image[0]; ?>
